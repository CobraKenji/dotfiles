...
sudo yum install -y cowsay ruby fortune-mod
cd /
wget -q -nc https://github.com/busyloop/lolcat/archive/master.zip
unzip -n master.zip
cd lolcat-master/bin
sudo gem install lolcat
df -h | cowsay
fortune | cowsay | /home/froggy/bin/lolcat
cat > /etc/profile.d/amotd.sh << 'EOF' 
#!/bin/bash
# get free memory
